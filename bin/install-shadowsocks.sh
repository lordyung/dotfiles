...
download_files(){
    ...
    if ! wget --no-check-certificate -O libsodium-1.0.12.tar.gz http://mirrors.ustc.edu.cn/gentoo/distfiles/libsodium-1.0.12.tar.gz; then
...
install_ss(){
    ...
    echo
    echo "Congratulations, shadowsocks client install completed!"
    echo -e "Your Local IP: \033[41;37m 127.0.0.1 \033[0m"
    echo -e "Your Local Port: \033[41;37m 1080 \033[0m"
    echo
    echo "Enjoy it!"
